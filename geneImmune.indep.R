...
setwd("C:\\Users\\78570\\Desktop\\122geneImmune\\29.indep")     #设置工作目录
...
indep=function(riskFile=null,cliFile=null,uniOutFile=null,multiOutFile=null,uniForest=null,multiForest=null){
	...
	bioForest(coxFile=uniOutFile, forestFile=uniForest, forestCol="deepskyblue")
	...
	bioForest(coxFile=multiOutFile, forestFile=multiForest, forestCol="mediumvioletred")
}
